...
function htmlVictoryMessage(e, t, n, r=!0) {
    ...
    0 != i.length ? centerContent(n, l) : console.error("msgbox NOT found again")
}
function setGameCss() {
    if (!verifyStyle(".ms-game-msgbox")) {
        let t = 68;
        var e = jQuery("<style>.ms-game-msgbox{  display:inline-block;  position:absolute;  border:1px solid #grey;  box-shadow: 7px 7px 4px grey;  width:" + 180 + "px;  height:" + t + "px;}.ms-game-msgbox p{  line-height:" + t + "px;  text-align:center;  color:#f00; background-color:#fff;  font-size:125%;}.ms-game-msgbox p span{  color:#f00;}</style>");
        jQuery("html > head").append(e)
    }
}
function verifyStyle(e) {
    var t, n = !1;
    if (null != typeof document.styleSheets) {
        var r = document.styleSheets;
        e: for (var o = 0; o < r.length; o++) {
            if (void 0 === (t = null != typeof r[o].cssRules ? r[o].cssRules : r[o].rules))
                return !1;
            for (var l = 0; l < t.length; l++)
                if (t[l].selectorText == e) {
                    n = !0;
                    break e
                }
        }
...
function centerContent(e, t) {
    let n = jQuery(e);
    0 == n.length && console.error("centerContent: not found outer =" + e);
    let r = n.position()
      , o = parseInt(n.css("margin-top").replace("px", ""), 10);
    var l = jQuery(t);
    0 == l.length && console.error("centerContent: not found inner =" + t),
    l.css("left", r.left + (n.width() - l.width()) / 2),
    l.css("top", r.top + o + (n.height() - l.height()) / 2)
}
